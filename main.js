(() => {
    ...
    const TRANSLATIONS = {
        en: {
            ...
            // Who page
            'who.title': 'Who am I?',
            'who.intro.p1': 'Came to design through visual systems — logos, brand identities, before any formal training. What took root: a curiosity for systems, and the drive to build tools as much as to use them.',
            ...
            'who.intro.p3': 'What draws me: SaaS environments where design shapes how organizations actually operate. A decision framework that held, a component system that accelerated the team, user research that redirected a roadmap. I\'m looking for roles where design co-pilots product strategy.',
            ...
            'who.desc.oplit':       '<p><strong>Industrial scheduling &amp; capacity planning SaaS.</strong> Expert users — schedulers, planners, shop-floor operators — in luxury watchmaking, automotive, aerospace, and precision engineering. 3 years of accumulated research, 9+ clients interviewed.</p><p><strong>Strategic feature design</strong> (capacity transfer, multi-select, planning views) co-created with clients. Each feature ships with a dedicated tracking plan (Mixpanel): measured adoption, tracked user satisfaction, direct impact on new client deployments and business development.</p><p><strong>In parallel:</strong> Opal design system ownership — the long-term foundation that structures and accelerates everything — and a Figma audit plugin built in JavaScript.</p>',
            ...
            'who.desc.teacher':     '<ul><li>1st year — Design &amp; UX/UI fundamentals</li><li>2nd year — Figma training</li></ul>',
        ...
        fr: {
            ...
            'who.intro.p1': 'Venu au design par les systèmes visuels — logos, identités graphiques, avant toute formation. Ce qui a pris racine : une curiosité pour les systèmes et l\'envie de construire les outils autant que de les utiliser.',
            ...
            'who.intro.p3': 'Ce qui m\'attire : les environnements SaaS où le design façonne comment les organisations fonctionnent. Un cadre de décision qui tient, un système de composants qui accélère l\'équipe, une research qui réoriente une roadmap. Je cherche des rôles où le design co-pilote la stratégie produit.',
            ...
            'who.desc.oplit':       '<p><strong>SaaS d\'ordonnancement industriel &amp; planification capacitaire.</strong> Utilisateurs experts — planificateurs, ordonnanceurs, opérateurs atelier — dans l\'horlogerie de luxe, l\'automobile, l\'aéronautique et la mécanique fine. 3 ans de recherche capitalisée, 9+ clients interviewés.</p><p><strong>Conception de features stratégiques</strong> (transfert de charge, multi-sélection, vues planning) en co-création avec les clients. Chaque feature est livrée avec un tracking plan dédié (Mixpanel) : adhérence mesurée, satisfaction utilisateur trackée, impact direct sur le déploiement chez de nouveaux clients et le développement commercial.</p><p><strong>En parallèle :</strong> ownership du design system Opal — le socle long terme qui structure et accélère l\'ensemble — et développement d\'un plugin Figma d\'audit en JavaScript.</p>',
            ...
            'who.desc.teacher':     '<ul><li>1ère année — Bases du design et UX/UI</li><li>2ème année — Formation Figma</li></ul>',
            ...
            'case.ca.research_discovery': '<p>Pas de research spécifique — insights issus directement de la research Sign in/Sign up (5 interviews + Mixpanel + support). Benchmark : Shopify, WooCommerce, Wix ont tous un espace compte centralisé → standard marché, pas innovation.</p>',

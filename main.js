(() => {
    ...
    const TRANSLATIONS = {
        en: {
            ...
            'case.dsskills.subtitle': 'The morning my PM took a prototype to a client without me. Two AI skills that let the design system build screens from a plain-language brief, and what that did to the craft.',
        ...
        fr: {
            ...
            'case.dsskills.subtitle': 'Le matin où mon PM a présenté un prototype à un client, sans moi. Deux skills IA qui permettent au design system de construire des écrans à partir d\'un brief en langage naturel, et ce que ça fait au métier.',
